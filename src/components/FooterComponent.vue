<template>
    <footer>
        <div class="container grid grid-column width-100 gap-25">
            <div class="grid grid-row width-100 grid-2rows_new gap-25">
                ...
                <div class="footer__card_text wrap_card grid align-items-center justify-items-center">
